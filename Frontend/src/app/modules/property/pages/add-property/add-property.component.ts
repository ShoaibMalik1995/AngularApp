...
import { IProperty } from 'src/app/modules/property/interfaces/IProperty.interface';
...
export class AddPropertyComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private alertifyService: ToastrService,
  ...
  onSubmit() {
    try {
      ...
      if(this.ValidateAllTabs()){
        ...
        this.alertifyService.error("Congrats ! Your Property is listed in out website successfully.");
